...
Процедура ИзменитьКод(Направление) Экспорт
	...
	УправОтчеты  = Справочники.УправленческиеОтчеты;
	ВыборкаОтчеты = УправОтчеты.Выбрать(Родитель, Владелец, , "Код Убыв");
	...
	ЭлементЗаменыСсылка   = УправОтчеты.НайтиПоКоду(КодЭлементаЗамены,,Родитель, Владелец);
	Если ЭлементЗаменыСсылка <> УправОтчеты.ПустаяСсылка() Тогда
		...
		Если ЭлементЗамены.ЭтоГруппа Тогда
			...
			ВыборкаОтчеты = УправОтчеты.Выбрать(ЭлементЗаменыСсылка, ЭлементЗамены.Владелец, , "Код Убыв");
	...
	Если ЭтоГруппа Тогда
		...
		// Переписываем коды вложенных в группу элементов.
		ВыборкаОтчеты = УправОтчеты.Выбрать(ЭтотОбъект.Ссылка, Владелец, , "Код Убыв");
...
Процедура ПередЗаписью(Отказ)
	...
	Если НЕ ЭтоНовый() Тогда
		...
		Если ПрежнийРодитель <> Родитель Тогда
			...
			УправОтчеты   = Справочники.УправленческиеОтчеты;
			ВыборкаОтчеты  = УправОтчеты.Выбрать(Родитель, Владелец, , "Код Возр");
