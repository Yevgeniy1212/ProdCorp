...
Функция СформироватьНаименование()
	...
	Символов = Цел(150/(Выборка.Количество()+4))-1;

	ОбработанныеРазрезы=Новый Массив;
	мРезультат=мРезультат+?(мРезультат="","","/")+Лев(Строка(УправленческоеПодразделение),Символов);
	мРезультат=мРезультат+?(мРезультат="","","/")+Лев(Строка(Проект),Символов);
	мРезультат=мРезультат+?(мРезультат="","","/")+Лев(Строка(Контрагент),Символов);
	мРезультат=мРезультат+?(мРезультат="","","/")+Лев(Строка(Номенклатура),Символов);
