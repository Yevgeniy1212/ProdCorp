...
Процедура ОткрытьФормуНовойКатегории(ФормаВладелец) Экспорт
	...
	Если ОбщегоНазначения.ПроверитьПравоДоступа(Метаданные.Справочники.КатегорииОбъектов, "Добавление", Истина) Тогда
...
Функция ЗаписатьКатегорииОбъекта() Экспорт
	...
	Если ОбщегоНазначения.ПроверитьПравоДоступа(Метаданные.РегистрыСведений.КатегорииОбъектов, "Изменение", Истина) Тогда
...
Функция ЗначенияКатегорийМодифицированы() Экспорт
	...
	Возврат НЕ ОбщегоНазначения.СравнитьТаблицыНаборовЗаписей(ТаблицаЗапроса, ТаблицаКатегорий);
