...
Перем КаталогДопИнфо Экспорт;	// Временный каталог хранения страниц
Перем ТаблицаСтраниц Экспорт;	// Таблица страниц
...
// ДанныеАктуальны
//  Проверяет актуальность данных дополнительной информации
// Параметры
...
// Очищает временный каталог хранения страниц
// открывает финальные страницы
...
КаталогДопИнфо = КаталогВременныхФайлов()+АдресРесурсовОбозревателя+"\DopInfoOtrasl";
