...
Процедура ПроизвестиОтборДанных(ЗначениеОтбора, Знач ПредлагатьСнятьИерархическийПросмотр = Ложь,
	...
	Если УстановитьБыструюНастройкуОтбора Тогда
		...
		куфиб_ОбщегоНазначения.ДобавитьВСписокЗначенийУнивер(СписокЗначенийОтбораДанных, ПрефиксНазванияСпискаДляСохранения + ИмяНастройкаОтбораДанных, ОбъектФормыЗначениеОтбораСпискаДанных, ЗначениеОтбора);
	Иначе
	...
	Если ПредлагатьСнятьИерархическийПросмотр Тогда
		Если ЗначениеЗаполнено(ЗначениеОтбора) 
			...
			ИерархическийПросмотрФормы = ВосстановитьЗначение("ИерархическийПросмотрФормы");
			Если ИерархическийПросмотрФормы = Неопределено Или ИерархическийПросмотрФормы = Истина Тогда 
				ОтветНаВопрос = Вопрос("Для удобства поиска рекомендуется снять режим иерархического просмотра. Снять?" + Символы.ПС + "Выбранное значение будет сохранено. Сбросить значение можно в меню ""Сервис"" - ""Служебные"" - ""Обновить системную информацию""", РежимДиалогаВопрос.ДаНет);
				Если ОтветНаВопрос = КодВозвратаДиалога.Да Тогда
					ОбъектФормыСписок.ИерархическийПросмотр = Ложь;
					ИерархическийПросмотрФормы = Ложь; 
					СохранитьЗначение("ИерархическийПросмотрФормы", ИерархическийПросмотрФормы);
				Иначе 
					ИерархическийПросмотрФормы = Истина; 
					СохранитьЗначение("ИерархическийПросмотрФормы", ИерархическийПросмотрФормы);
				КонецЕсли;
			Иначе 
				ОбъектФормыСписок.ИерархическийПросмотр = Ложь;
...
Функция ЗаполнитьСписокЗначенийОтборовДанных() Экспорт
	...
	КонецЦикла;
	Если НЕ ТипОбъектовПоиска = Тип("СправочникСсылка.ОсновныеСредства") Тогда
...
Процедура ВыполнитьОтборПоНастройкеДляСпискаВыбора(ЗначениеОтбораДанных, ИмяОтбораДанных, ПредставлениеНастройкиОтбора) Экспорт
	...
	куфиб_ОбщегоНазначения.ВосстановитьСписокЗначенийУнивер(СписокЗначенийОтбораДанных, ПрефиксНазванияСпискаДляСохранения + ПредставлениеНастройкиОтбора, ОбъектФормыЗначениеОтбораСпискаДанных.СписокВыбора);	
...
Процедура ВосстановитьСписокОтбораДанных() Экспорт
	куфиб_ОбщегоНазначения.ВосстановитьСписокЗначенийУнивер(СписокЗначенийОтбораДанных, ПрефиксНазванияСпискаДляСохранения + НастройкаОтбораДанных, ОбъектФормыЗначениеОтбораСпискаДанных.СписокВыбора);
КонецПроцедуры
