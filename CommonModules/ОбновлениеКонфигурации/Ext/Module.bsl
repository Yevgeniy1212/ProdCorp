...
Функция АдресРесурсовДляПроверкиНаличияОбновления() Экспорт
	...
	Результат = "/ipp/ITSREPV/V8Update/Configs/" + ОбновлениеКонфигурации.КороткоеИмяКонфигурации() + "/";
...
Процедура ПриПереходеНаСтраницуПомощника(ПомощникОбновления, ПредыдущаяСтраница, СледующаяСтраница, Отказ) Экспорт
	...
	#Если Клиент Тогда
// блок проверки легальности получения обновления, 
// вставить после подоготовки текста. 
	#КонецЕсли
