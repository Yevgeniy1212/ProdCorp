...
//
Процедура СоздатьДокументНаОсновеФайла(СписокФайлов,
                                       ВладелецФайла,
                                       ФормаВладелец,
	...
	//+++ Oleg SmartT. 2021-11-19
	Для Каждого ПолноеИмяФайла Из СписокФайлов Цикл 
	...
	Если НеОткрыватьКарточкуПослеСозданияИзФайла <> Истина Тогда
		...
		//т.к. был установлен множественный выбор файлов, то не открываем
...
Процедура СоздатьФайл(РежимСоздания,
	...
	ИначеЕсли РежимСоздания = 2 Тогда
		...
		Если РасширениеПодключено Тогда
			...
			ПолноеИмяФайла = ВыборФайла.ВыбранныеФайлы; 
			//--- Oleg SmartT. 2021-11-19
