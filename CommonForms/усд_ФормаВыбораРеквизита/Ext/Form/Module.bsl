...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ВидДанных") Тогда
		...
		КонецЕсли;
	ИначеЕсли Параметры.Свойство("ВидДокументов") Тогда
	...
	ИначеЕсли Параметры.Свойство("СсылкаНаОбъект") Тогда
		ТипОбъекта = ТипЗнч(Параметры.СсылкаНаОбъект);
		ОбъектТипа = Новый(ТипОбъекта);
		фин_ПроцедурыМеханизмовБюджетирования.ЗаполнитьДеревоРеквизитовОбъекта(ДеревоФормы,ОбъектТипа.Метаданные());
	Иначе
		Отказ = Истина;
		Возврат;
	КонецЕсли;
