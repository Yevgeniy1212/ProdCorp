...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("ПериодПланирования") Тогда
		...
		Элементы.ПериодПланирования1.ТолькоПросмотр=Истина;
