...
Функция ПодготовитьОтчетКВыводуНаПечать()
	...
	|	И СчетФактураВыданный.Организация В (&Организации)" +?(ПризнакОтбораПоТипуОперации," И СчетФактураВыданный.ДокументыОснования.ДокументОснование.ТипОперации в Иерархии(&ТипОперации)","") + ?(ПризнакОтбораПоКонтрагенту, " И (СчетФактураВыданный.Контрагент В ИЕРАРХИИ (&Контрагент) ИЛИ СчетФактураВыданный.Покупатель В ИЕРАРХИИ (&Контрагент))",""); 	                          
