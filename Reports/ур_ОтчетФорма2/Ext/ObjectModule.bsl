...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	СписокВидовОперацийДляОтбора = Новый Массив;
	СписокВидовОперацийДляОтбора.Добавить(Перечисления.ВидыТиповОпераций.Закуп);
	СписокВидовОперацийДляОтбора.Добавить(Перечисления.ВидыТиповОпераций.Перемещение);
	СписокВидовОперацийДляОтбора.Добавить(Перечисления.ВидыТиповОпераций.Реализация);
	
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокВидовОперацийДляОтбора", СписокВидовОперацийДляОтбора);
