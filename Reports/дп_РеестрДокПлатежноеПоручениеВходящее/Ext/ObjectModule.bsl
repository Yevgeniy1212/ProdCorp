...
Функция ПолучитьТекстЗаголовка(ОрганизацияВНачале = Истина) Экспорт 
	...
	ЗаголовокОтчета = "Реестр документов платежное поручение входящее " + СтандартныеОтчеты.ПолучитьПредставлениеПериода(ЭтотОбъект);
...
Функция ПолучитьВыборку()
	...
	|	ВЫБОР КОГДА ПлатежноеПоручениеВходящее.ВалютаДокумента <> &мВалютаРегламентированногоУчета 
	|	ТОГДА
	|		ПлатежноеПоручениеВходящее.СуммаДокумента*ПлатежноеПоручениеВходящее.КурсНаДатуПриобретенияРеализацииВалюты
	|	ИНАЧЕ
	|       ПлатежноеПоручениеВходящее.СуммаДокумента
	|   КОНЕЦ  КАК СуммаДокумента,
	|	ПлатежноеПоручениеВходящее.ТипОперации,
