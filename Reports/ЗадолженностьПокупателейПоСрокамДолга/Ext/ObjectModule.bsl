...
Процедура УстановитьТекстЗапроса()
	...
	|		ВзаиморасчетыОстатки.СуммаОстатокДт КАК ОстатокДолга0
	|	ИЗ
...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	Запрос.УстановитьПараметр("СчетаРасчетов"    , ОтчетыДляРуководителя.ВозвратитьМассивСчетовДтКтЗадолженности(Ложь, Истина, Истина));
