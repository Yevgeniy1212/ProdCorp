...
Функция ПолучитьТекстЗаголовка(ОрганизацияВНачале = Истина) Экспорт 
	...
	ЗаголовокОтчета = "Реестр документов реализация зерна " + СтандартныеОтчеты.ПолучитьПредставлениеПериода(ЭтотОбъект);
...
Функция ПолучитьВыборку()
	...
	Текст =
	"ВЫБРАТЬ
	|	ур_РеализацияЗерна.Номер,
	|	ур_РеализацияЗерна.Дата,
	|	ВЫБОР
	|		КОГДА ур_РеализацияЗерна.СуммаВключаетНДС
	|			ТОГДА (ур_РеализацияЗерна.СуммаДокумента)*ур_РеализацияЗерна.КурсВзаиморасчетов
	|		ИНАЧЕ (ур_РеализацияЗерна.СуммаДокумента + ДанныеПоТЧ.СуммаНДС)*ур_РеализацияЗерна.КурсВзаиморасчетов
	|	КОНЕЦ КАК СуммаДокумента,
	|	ур_РеализацияЗерна.СуммаВключаетНДС,
	|	ур_РеализацияЗерна.Организация,
	|	ур_РеализацияЗерна.Контрагент,
	|	ур_РеализацияЗерна.ДоговорКонтрагента,
	|	ур_РеализацияЗерна.ТипОперации,
	|	ур_РеализацияЗерна.ВалютаДокумента,
	|	ур_РеализацияЗерна.КурсВзаиморасчетов,
	|	ур_РеализацияЗерна.КратностьВзаиморасчетов,
	|	ур_РеализацияЗерна.Комментарий,
	...
	|		ПО (ДанныеПоТЧ.ТекДокумент = ур_РеализацияЗерна.Ссылка)
	|ГДЕ
	|	ур_РеализацияЗерна.Дата МЕЖДУ &НачалоПериода И &КонецПериода
	|	И ур_РеализацияЗерна.Проведен";	

	Запрос.УстановитьПараметр("НачалоПериода",НачалоДня(НачалоПериода));
	Запрос.УстановитьПараметр("КонецПериода", КонецДня(КонецПериода));
	Запрос.УстановитьПараметр("мВалютаРегламентированногоУчета", Константы.ВалютаРегламентированногоУчета.Получить());
