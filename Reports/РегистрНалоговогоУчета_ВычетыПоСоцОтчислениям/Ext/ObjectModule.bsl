...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	СписокСчетов.Добавить(ПланыСчетов.Типовой.ОбязательстваПоСоциальномуСтрахованию);
	
	СписокСчетовНеДляНУ = Новый Массив;
	СписокСчетовНеДляНУ.Добавить(ПланыСчетов.Типовой.ПрочиеАдминистративныеРасходыНеОтносимыеНавычет);
	СписокСчетовНеДляНУ.Добавить(ПланыСчетов.Типовой.КраткосрочнаяДебиторскаяЗадолженностьПредставительств);
	СписокСчетовНеДляНУ.Добавить(ПланыСчетов.Типовой.ИныеНалогиИОбязательныеПлатежиВБюджетСоцОтчисленияСоб);
	...
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовНеДляНУ", СписокСчетовНеДляНУ);
...
Процедура ВыводЗаголовкаОтчета(ОтчетОбъект, Результат)
	...
	ОбластьЗаголовок.Параметры.ВидОтчета = "Социальные отчисления в ГФСС";
