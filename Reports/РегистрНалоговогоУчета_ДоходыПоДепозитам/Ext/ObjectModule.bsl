...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	СписокСчетовДС = Новый Массив;
	СписокСчетовДС.Добавить(ПланыСчетов.Типовой.ДенежныеСредства);
	
	СписокСчетовДоходов = Новый Массив;
	СписокСчетовДоходов.Добавить(ПланыСчетов.Типовой.ДоходыПоВознаграждениямПоТекущимКорСчетам);
	...
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовДС", СписокСчетовДС);
...
Процедура ВыводЗаголовкаОтчета(ОтчетОбъект, Результат)
	...
	ОбластьЗаголовок.Параметры.ВидОтчета = "Вознагрождение по депозитам";
