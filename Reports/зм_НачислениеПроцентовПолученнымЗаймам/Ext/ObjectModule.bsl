...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ВалСуммаПолучения",   "Вал.сумма",       Истина, "ЧЦ=17; ЧДЦ=2", "Начислено", "Начислено %");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаПолучения",   "Сумма в тенге",       Истина, "ЧЦ=17; ЧДЦ=2", "Начислено", "Начислено %");
	
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаКурсПриПол",   "Курсовая разница",       Истина, "ЧЦ=17; ЧДЦ=2", , );
	
	
	УниверсальныйОтчет.ДобавитьПоказатель("ВалСуммаПогашения",   "Вал.сумма",       Истина, "ЧЦ=17; ЧДЦ=2", "Погашено", "Погашено %");
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаПогашения",   "Сумма в тенге",       Истина, "ЧЦ=17; ЧДЦ=2", "Погашено", "Погашено %");
