...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	СписокСчетовПоставщиков = Новый Массив;
	СписокСчетовПоставщиков.Добавить(Планысчетов.Типовой.КраткосрочнаяЗадолженностьПоставщикамИПодрядчикам);
	
	СписокСчетовПодотчетников = Новый Массив;
	СписокСчетовПодотчетников.Добавить(Планысчетов.Типовой.КраткосрочнаяДебиторскаяЗадолженностьРаботников);
	
	СписокСчетов = Новый Массив;
	СписокСчетов.Добавить(Планысчетов.Типовой.КраткосрочнаяЗадолженностьПоставщикамИПодрядчикам);
	СписокСчетов.Добавить(Планысчетов.Типовой.КраткосрочнаяДебиторскаяЗадолженностьРаботников);
	
	мВИдыСубконто1 = Новый Массив;
	мВИдыСубконто1.Добавить(ПланыВидовХарактеристик.ВидыСубконтоТиповые.СтатьиЗатрат);
	...
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовПоставщиков", СписокСчетовПоставщиков);
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовПодотчетников", СписокСчетовПодотчетников);
