...
Функция ПолучитьВыборку()
	...
	//|	(1+ТиповойОстатки.Субконто3.СтавкаНДС.Ставка/100) КАК ПроцентНДС,
	|	&СтавкаНДС КАК ПроцентНДС,
	|	ТиповойОстатки.Субконто3.СтавкаНДС КАК СтавкаНДС,
	...
	|	ТиповойОстатки.СуммаОстатокДт*&СтавкаНДС КАК СуммаОстатокСНДС,
	//|	ВЫБОР КОГДА ТиповойОстатки.КоличествоОстатокДт>0
	//|   	ТОГДА ТиповойОстатки.Сум*(1+ТиповойОстатки.Субконто3.СтавкаНДС.Ставка/100
	...
	|	РегистрБухгалтерии.Типовой.Остатки(&Период, Счет в (&СчетОтбора), , Субконто1.Зерно) КАК ТиповойОстатки
	|";
	...
	мСписокНоменклатурныхСчетов = УправлениеРесурсами.СформироватьСписокСчетовУчетаРесурсов(); 
