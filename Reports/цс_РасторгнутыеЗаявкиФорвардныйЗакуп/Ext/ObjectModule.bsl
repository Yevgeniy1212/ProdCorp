...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	НоваяСтрока.СчетУчета = Планысчетов.Типовой.ТоварыВПутиГос;
...
Процедура ВыводЗаголовкаОтчета(ОтчетОбъект, Результат)
	...
	//ОбластьЗаголовок1 = МакетЗаголовок.ПолучитьОбласть("Заголовок");
	//ТекстОписания =  "Приложение №3
	//|к Процедурам форвардного закупа АО «НК «Продкорпорация» 
	//|пшеницы и ячменя у субъектов агропромышленного комплекса
	//|посредством весенне-летнего финансирования,
	//|утвержденным решением 
	//|Правления АО «НК «Продкорпорация»
	//|от «___»______________ "+Год(КонецПериода)+" года №___";
	//ОбластьЗаголовок1.Параметры.ЗаголовокОтчета = ТекстОписания;
	//ОбластьЗаголовок1.Области.Заголовок.ШиринаКолонки=160;
	//ОбластьЗаголовок1.Области.Заголовок.ГоризонтальноеПоложение =  ГоризонтальноеПоложение.Право;
	//ОбластьЗаголовок1.Области.Заголовок.Шрифт = Новый Шрифт(,8,Истина);
	//Результат.Вывести(ОбластьЗаголовок1);
	...
	//ОбластьЗаголовок.Параметры.Описание = ТекстОписания;
	ОбластьЗаголовок.Области.Заголовок.ШиринаКолонки=160;
    ОбластьЗаголовок.Области.Заголовок.ГоризонтальноеПоложение =  ГоризонтальноеПоложение.Центр;
...
Функция ПолучитьТекстЗаголовка(ОрганизацияВНачале = Истина) Экспорт 
	...
	ЗаголовокОтчета = "Отчет по расторгнутым заявкам
	| по программе форвардного закупа сельскохозяйственной продукции " + СтандартныеОтчеты.ПолучитьПредставлениеПериода(ЭтотОбъект);
