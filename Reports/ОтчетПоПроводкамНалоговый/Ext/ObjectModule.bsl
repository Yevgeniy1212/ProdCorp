...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	Перем ВыводитьОрганизацию, ВыводитьСтруктурноеПодразделение;
	
	Если ЭтотОбъект.НастройкиФормы.Свойство("ВыводитьОрганизацию", ВыводитьОрганизацию) Тогда
		ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "ВыводитьОрганизацию", ВыводитьОрганизацию);
	КонецЕсли;
	
	Если ЭтотОбъект.НастройкиФормы.Свойство("ВыводитьСтруктурноеПодразделение", ВыводитьСтруктурноеПодразделение) Тогда
		Если НЕ ОбщегоНазначения.ПолучитьПризнакОтображенияСтруктурныхПодразделений() Тогда
			ВыводитьСтруктурноеПодразделение = Ложь;
		КонецЕсли;
		ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "ВыводитьСтруктурноеПодразделение", ВыводитьСтруктурноеПодразделение);
	КонецЕсли;
	...
	ТекущийНаборПоказателей = "" + ПоказателиОтчета.БУ.Значение + ПоказателиОтчета.Количество.Значение;
...
Функция ПолучитьТекстЗаголовка(ОрганизацияВНачале = Истина) Экспорт 
	...
	ЗаголовокОтчета = "Отчет по проводкам (налоговый учет) " + СтандартныеОтчеты.ПолучитьПредставлениеПериода(ЭтотОбъект);
...
Процедура ПолучитьСтруктуруПоказателейОтчета() Экспорт
	...
	ПоказателиОтчета = СтандартныеОтчеты.ПолучитьСтруктуруПоказателейОтчета(,,,, Ложь, Ложь, Истина, Ложь, Истина);
