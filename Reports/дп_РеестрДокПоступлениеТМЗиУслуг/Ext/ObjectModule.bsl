...
Функция ПолучитьТекстЗаголовка(ОрганизацияВНачале = Истина) Экспорт 
	...
	ЗаголовокОтчета = "Реестр документов поступления ТМЗ и услуг " + СтандартныеОтчеты.ПолучитьПредставлениеПериода(ЭтотОбъект);
...
|		ИНАЧЕ ПоступлениеТоваровУслуг.СуммаДокумента + ДанныеПоТЧ.СуммаНДС
...
|			ГДЕ
|				ОС.Ссылка.Дата МЕЖДУ &НачалоПериода И &КонецПериода
...
|		ПО (ДанныеПоТЧ.ТекДокумент = ПоступлениеТоваровУслуг.Ссылка)
|ГДЕ
