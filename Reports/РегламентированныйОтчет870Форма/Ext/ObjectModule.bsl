...
Функция ЗаполнитьСведенияОНалогоплательщике()Экспорт
	...
	//ОргСведения.Вставить("КодНалоговогоОргана", 	СокрЛП(Налогоплательщик.КодНалоговогоОрганаОПВиСО));
...
ИмяПакета = "http://www.fno870.plast.kz";
ИмяФайлаВыгрузки = "870.xml";
