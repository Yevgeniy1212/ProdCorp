...
// Процедура заполняет таблицу вида контактной информации - показателей отчета
// Возвращаемые значения
//  НЕТ
...
Процедура СформироватьОтчет(Таб, ТолькоЗаголовок = Ложь) Экспорт
	...
	УправлениеОтчетами.УстановитьКолонтитулыПоУмолчанию(Таб, "Отчет о контактной информации", Строка(глТекущийПользователь));	
КонецПроцедуры
