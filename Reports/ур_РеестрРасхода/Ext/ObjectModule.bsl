...
//Сахневич Удалил лишние слова в заголовке		
//	ЗаголовокОтчета = "РЕЕСТР РАСХОДА С УЧЕТОМ КОРРЕКТИРОВОК" + СтандартныеОтчеты.ПолучитьПредставлениеПериода(ЭтотОбъект);
