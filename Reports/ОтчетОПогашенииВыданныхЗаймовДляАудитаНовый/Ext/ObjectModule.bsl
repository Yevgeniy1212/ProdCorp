...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	НачалоМесяца = НачалоМесяца(ДобавитьМесяц(КонецМесяца(Период),-1));
	ДоОдногоМесяца = КонецМесяца(ДобавитьМесяц(КонецМесяца(Период),-1));
	ДоТрехМесяцев = НачалоМесяца(ДобавитьМесяц(КонецМесяца(Период),-3));
	ДоШестиМесяцев = НачалоМесяца(ДобавитьМесяц(КонецМесяца(Период),-6));
	ДоДевятиМесяцев = НачалоМесяца(ДобавитьМесяц(КонецМесяца(Период),-9));
	ДоГода = НачалоМесяца(ДобавитьМесяц(КонецМесяца(Период),-12));
	...
	Сообщить("НачалоМесяца - "+НачалоМесяца);
	Сообщить("ДоОдногоМесяца - "+ДоОдногоМесяца);
	Сообщить("ДоТрехМесяцев - "+ДоТрехМесяцев);
	Сообщить("ДоШестиМесяцев - "+ДоШестиМесяцев);
	Сообщить("ДоДевятиМесяцев - "+ДоДевятиМесяцев);
	Сообщить("ДоГода - "+ДоГода);
