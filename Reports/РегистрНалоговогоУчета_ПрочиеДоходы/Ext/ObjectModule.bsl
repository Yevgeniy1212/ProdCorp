...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	СписокСчетов.Добавить(ПланыСчетов.Типовой.НачисленныеДоходыВВидеВознагрожденийПоТекущимИКорреспонденскимСчетамСоб);
	
	мВИдыСубконто1 = Новый Массив;
	мВИдыСубконто1.Добавить(ПланыВидовХарактеристик.ВидыСубконтоТиповые.ДенежныеСредства);
	
	СписокСчетовКПН = Новый Массив;
	СписокСчетовКПН.Добавить(ПланыСчетов.Типовой.ИныеНалогиКПНСЮрЛицСоб);
	
	СписокСчетовДоходов = Новый Массив;
	СписокСчетовДоходов.Добавить(ПланыСчетов.Типовой.ДоходыПоВознаграждениям);
	
	мВИдыСубконто2 = Новый Массив;
	мВИдыСубконто2.Добавить(ПланыВидовХарактеристик.ВидыСубконтоТиповые.Доходы);
	
	СписокСчетовПрочихДоходов = Новый Массив;
	СписокСчетовПрочихДоходов.Добавить(ПланыСчетов.Типовой.ПрочиеДоходы);
	
	СписокСчетовПрочихДоходовИсключаемые = Новый Массив;
	СписокСчетовПрочихДоходовИсключаемые.Добавить(ПланыСчетов.Типовой.НеустойкиШтрафыПениСоб);
	
	мВИдыСубконто3 = Новый Массив;
	мВИдыСубконто3.Добавить(ПланыВидовХарактеристик.ВидыСубконтоТиповые.Контрагенты);
	...
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовКПН", СписокСчетовКПН);
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовДоходов", СписокСчетовДоходов);
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовПрочихДоходов", СписокСчетовПрочихДоходов);
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовПрочихДоходовИсключаемые", СписокСчетовПрочихДоходовИсключаемые);
...
Процедура ВыводЗаголовкаОтчета(ОтчетОбъект, Результат)
	...
	ОбластьЗаголовок.Параметры.ВидОтчета = "Прочие доходы";
