...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	//МассивПоказателейДоп.Добавить("КоличествоНУ");
	//МассивПоказателейДоп.Добавить("КоличествоПР");
	//МассивПоказателейДоп.Добавить("КоличествоВР");
...
Функция ПолучитьТекстЗаголовка(ОрганизацияВНачале = Истина) Экспорт 
	...
	ЗаголовокОтчета = "Обороты счета (налоговый учет) " + Счет + СтандартныеОтчеты.ПолучитьПредставлениеПериода(ЭтотОбъект);
