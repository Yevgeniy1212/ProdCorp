...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	СписокВидовОперацийРеализации = Новый Массив;
	СписокВидовОперацийРеализации.Добавить(Перечисления.ур_ВидыОперацииРеализацииЗерна.НаЭкспорт);
	
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокВидовОперацийРеализации", СписокВидовОперацийРеализации);
...
Процедура ВыводЗаголовкаОтчета(ОтчетОбъект, Результат)
	...
	ОбластьЗаголовок.Параметры.ЗаголовокОтчета = "Налоговый регистр : ";
	ОбластьЗаголовок.Параметры.ВидОтчета = "Реализация на экспорт";
