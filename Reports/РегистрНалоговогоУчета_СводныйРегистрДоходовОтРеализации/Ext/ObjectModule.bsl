...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	СписокСчетДоходовОтРеализации = Новый Массив;
	СписокСчетДоходовОтРеализации.Добавить(Планысчетов.Типовой.ДоходОтРеализацииПродукцииИОказанияУслуг);
	
	СписокПрочихСчетовДоходов = Новый Массив;
	СписокПрочихСчетовДоходов.Добавить(Планысчетов.Типовой.ДоходыОтФинансирования);
	СписокПрочихСчетовДоходов.Добавить(Планысчетов.Типовой.ПрочиеДоходы_);
	
	СписокИсключаемыхСчетов = Новый Массив;
		
	СписокСчетовКурсовыхРазниц = Новый Массив;
	СписокСчетовКурсовыхРазниц.Добавить(Планысчетов.Типовой.ДоходыОтКурсовойРазницы);
	
	СписокСчетовКурсовыхРазницРасх = Новый Массив;
	СписокСчетовКурсовыхРазницРасх.Добавить(Планысчетов.Типовой.РасходыПоКурсовойРазнице);
	
	мСписокСчетовКурсовыхРазниц = Планысчетов.Типовой.ДоходыОтКурсовойРазницы;
	
	мВИдыСубконто1 = Новый Массив;
	мВИдыСубконто1.Добавить(ПланыВидовХарактеристик.ВидыСубконтоТиповые.ТипыОпераций);
	
	мВИдыСубконто2 = Новый Массив;
	мВИдыСубконто2.Добавить(ПланыВидовХарактеристик.ВидыСубконтоТиповые.Доходы);
	...
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СчетДоходовОтРеализации", СписокСчетДоходовОтРеализации);
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СчетПрочихДоходов", СписокПрочихСчетовДоходов);
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокИсключаемыхСчетов", СписокИсключаемыхСчетов);
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовКурсовыхРазниц", СписокСчетовКурсовыхРазниц);
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовКурсовыхРазницРасх", СписокСчетовКурсовыхРазницРасх);
	//ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовКурсовыхРазницДохСоб", СписокСчетовКурсовыхРазницДохСоб);
	//ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовКурсовыхРазницРасхГос", СписокСчетовКурсовыхРазницРасхГос);
	//ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовКурсовыхРазницРасхСоб", СписокСчетовКурсовыхРазницРасхСоб);
	...
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "мСписокСчетовКурсовыхРазниц", мСписокСчетовКурсовыхРазниц);
...
Процедура ВыводЗаголовкаОтчета(ОтчетОбъект, Результат)
	...
	ОбластьЗаголовок.Параметры.ЗаголовокОтчета = "Сводный регистр доходов от реализации товаров (выполнения работ, оказания услуг) ";
