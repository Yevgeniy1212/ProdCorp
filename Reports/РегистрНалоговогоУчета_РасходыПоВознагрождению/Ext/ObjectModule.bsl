...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	СписокСчетов.Добавить(ПланыСчетов.Типовой.НачисленныеРасходыВВидеВознагрожденийПоПолученнымЗаймам);
	
	СписокСчетовПоОблигациям = Новый Массив;
	СписокСчетовПоОблигациям.Добавить(ПланыСчетов.Типовой.НачисленныеРасходыВВидевознагрожденийПоВыпущеннымЦеннымБумагам);
	...
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовПоОблигациям", СписокСчетовПоОблигациям);
...
Процедура ВыводЗаголовкаОтчета(ОтчетОбъект, Результат)
	...
	ОбластьЗаголовок.Параметры.ВидОтчета = "Расходы по вознагрождениям";
