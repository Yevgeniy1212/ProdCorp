...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ИмяРегистра = "дс_ДвиженияДенежныхСредств";
	...
	//УниверсальныйОтчет.ДобавитьИзмерениеСтроки("ГодУрожая");
	//УниверсальныйОтчет.ДобавитьИзмерениеСтроки("Культура");
	//УниверсальныйОтчет.ДобавитьИзмерениеСтроки("Класс");
	//
