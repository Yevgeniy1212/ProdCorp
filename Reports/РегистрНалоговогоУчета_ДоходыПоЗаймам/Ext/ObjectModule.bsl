...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	СписокСчетов.Добавить(Планысчетов.Типовой.ДоходыПоВознаграждениямПоЗаймам);
	СписокСчетов.Добавить(Планысчетов.Типовой.ПрочиеДоходыПоВознаграждениямСоб);
...
Процедура ВыводЗаголовкаОтчета(ОтчетОбъект, Результат)
	...
	ОбластьЗаголовок.Параметры.ВидОтчета = "Доходы в виде вознагрождения по кредиту(займу,микрокредиту) операциям репо";
