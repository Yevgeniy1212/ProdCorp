...
Процедура ВыводЗаголовкаОтчета(ОтчетОбъект, Результат)
	...
	ТекстОписания =  "Приложение № 8
	|к Процедурам закупа
	|АО «НК «Продкорпорация» зерна
	|на условиях оплаты по факту поставки,
...
Функция ПолучитьТекстЗаголовка(ОрганизацияВНачале = Истина) Экспорт 
	...
	ЗаголовокОтчета = "Реестр на оплату за поставленное зерно,
	|по заключенным договорам закупа зерна на условиях оплаты по факту поставки " + СтандартныеОтчеты.ПолучитьПредставлениеПериода(ЭтотОбъект);
