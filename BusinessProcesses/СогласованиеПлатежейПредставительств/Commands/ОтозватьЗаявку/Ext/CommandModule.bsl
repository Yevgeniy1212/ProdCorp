...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Запрос.УстановитьПараметр("ТочкаМаршрута", БизнесПроцессы.СогласованиеПлатежейПредставительств.ТочкиМаршрута.ПередачаВКазначейство);
	...
	Пока Выборка.Следующий() Цикл
		...
		ТекЗадача.ТочкаМаршрута = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПредставительств.ТочкаМаршрута.РаботаСЗаявкойАвтором");
