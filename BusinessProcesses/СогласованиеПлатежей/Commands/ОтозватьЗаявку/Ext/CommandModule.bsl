...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Запрос.УстановитьПараметр("ТочкаМаршрута", БизнесПроцессы.СогласованиеПлатежей.ТочкиМаршрута.ПередачаВКазначейство);
	...
	Пока Выборка.Следующий() Цикл
		...
		ТекЗадача.ТочкаМаршрута = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежей.ТочкаМаршрута.РаботаСЗаявкойАвтором");
