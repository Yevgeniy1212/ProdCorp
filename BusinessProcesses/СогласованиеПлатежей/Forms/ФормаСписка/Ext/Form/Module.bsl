...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	//+++ Oleg SmartT. 2021-03-04
	// {{ Начало Аксиома: Попов В.С. 28.04.2024 13:33
	//Если Копирование Тогда
	Если Копирование и НЕ РольДоступна("axm_РазрешитьКопированиеСогласованияПлатежей") Тогда
	// }} Окончание  Аксиома: Попов В.С.
		Предупреждение("Копировать запрещено"); 
		Отказ = Истина; 
	КонецЕсли;
	//--- Oleg SmartT. 2021-03-04	
КонецПроцедуры
