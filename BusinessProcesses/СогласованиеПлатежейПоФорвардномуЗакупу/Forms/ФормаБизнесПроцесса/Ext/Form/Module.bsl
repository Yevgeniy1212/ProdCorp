...
Процедура ОбновитьИсториюИзменений()
	...
	КонецЦикла;
	Макет = БизнесПроцессы.СогласованиеПлатежейПоФорвардномуЗакупу.ПолучитьМакет("Макет");
...
Процедура ПодготовитьФорму(Форма)
	...
	Если Объект.стартован 
		и не ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.РаботаСЗаявкойАвтором") Тогда
	...
	Если ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.СогласованиеСРП") 				тогда
		Элементы.ЗаявкаПрошлаСогласованиеРук.Доступность 		= истина;
		
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.СогласованиеСГБ")			тогда       
		Элементы.ЗаявкаПрошлаСогласованиеГБ.Доступность 		= истина;
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.СогласованиеСФД")			тогда
		Элементы.ЗаявкаПрошлаСогласованиеРуководительФД.Доступность 		= истина;
		
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.СогласованиеСКурирующимЧП")			тогда
		Элементы.ЗаявкаПрошлаСогласованиеКурирующимЧП.Доступность 		= истина;
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.ПередачаВКазначейство")	тогда
		Элементы.ПроверкаНаПолнотуСведенийВыполнена.Доступность = истина;
		Элементы.РасчетнаяТаблицаРасчетныйСчет.Доступность 		= Истина;
	//ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.СогласованиеСРуководителемКД")	тогда
	//	Элементы.ПроверкаДиректоромКДВыполнена.Доступность 		= Истина;
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.РаботаСЗаявкойАвтором")
	...
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.СозданиеПП")	тогда
...
Процедура ВыполнитьЭтап(Команда)
	ОбработатьБП("ОК");
	ОповеститьОбИзменении(ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ПустаяСсылка"));
...
Функция ОбработатьЭтап(РезультатВозврата)
	...
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.СогласованиеССогласующим")			тогда
