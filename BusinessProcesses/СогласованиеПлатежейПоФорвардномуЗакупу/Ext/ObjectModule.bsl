...
Процедура ПриСозданииЗадач(ТочкаМаршрутаБизнесПроцесса, ФормируемыеЗадачи, Отказ)
	...
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.РаботаСЗаявкойАвтором") Тогда
...
Процедура РезультатПроверкиВыбораВарианта(ТочкаВыбораВарианта, Результат)
	...
	Если ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.РезультатПроверкиСТП") Тогда
		МаркерЭтапа = ЗаявкаПрошлаСогласованиеРук;
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.РезультатПроверкиКурирующимЧП")	Тогда
		МаркерЭтапа = ЗаявкаПрошлаСогласованиеКурирующимЧП; 
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.РезультатПроверкиСогласующий")	Тогда
		МаркерЭтапа = ЗаявкаПрошлаСогласованиеСогласующим; 	
	//ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.РезльтатПроверкиКазначейства")	Тогда
	//	МаркерЭтапа = ПроверкаНаПолнотуСведенийВыполнена; 		
		
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.РезультатСогласованиеСГБ")	Тогда      
		МаркерЭтапа = ЗаявкаПрошлаСогласованиеГБ; 	
	ИначеЕсли ТекущаяТочка = ПредопределенноеЗначение("БизнесПроцесс.СогласованиеПлатежейПоФорвардномуЗакупу.ТочкаМаршрута.РезультатСогласованиеСФД")	Тогда      
