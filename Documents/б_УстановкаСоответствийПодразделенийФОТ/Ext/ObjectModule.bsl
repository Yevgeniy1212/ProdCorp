...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Для каждого СтрокаТЧ ИЗ СписокСоответствий Цикл
		//Зафиксировать 
		ДвижениеЗависимостей						= Движения.б_ЗакреплениеПодразделенийЗаСтатьямиФОТ.Добавить();
		...
		ДвижениеЗависимостей.Подразделение 			= СтрокаТЧ.Подразделение;
		ДвижениеЗависимостей.Бюджет 				= СтрокаТЧ.Бюджет;
		ДвижениеЗависимостей.СтатьяФОТ 				= СтрокаТЧ.СтатьяФОТ;
