...
Функция ПечатьГрафика()
	...
	|	ГрафикВознагрождений.ДоговорКонтрагента.СуммаДоговора КАК Сумма,
	|	ГрафикВознагрождений.ДоговорКонтрагента.ПроцентВознагрождения КАК ПроцентВознагрождения,
	|	ГрафикВознагрождений.ДоговорКонтрагента.ВИдКалендарныхДней КАК КоличествоДней
	|ИЗ
	|	Документ.ГрафикНачисленияВознагрожденийПоКредитамИЗаймам КАК ГрафикВознагрождений
	|ГДЕ
