...
Процедура Автозаполнение() Экспорт
	...
	Если РежимПланированияЗатрат = Перечисления.ВидыОрганизационнойСтруктурыПредприятия.ПоСтруктуреЮридическихЛиц Тогда
		...
		|	И (ОтражениеЗарплатыВРеглУчетеОтражениеВУчете.СубконтоДт1 ССЫЛКА Справочник.СтатьиЗатрат
		|		ИЛИ ОтражениеЗарплатыВРеглУчетеОтражениеВУчете.СубконтоДт2 ССЫЛКА Справочник.СтатьиЗатрат
		|		ИЛИ ОтражениеЗарплатыВРеглУчетеОтражениеВУчете.СубконтоДт3 ССЫЛКА Справочник.СтатьиЗатрат)
		|
		|СГРУППИРОВАТЬ ПО
...
Функция СформироватьЗапросПоШапке(Режим)
	...
	|	ПланируемыеЗатратыНаПерсонал.Организация,
