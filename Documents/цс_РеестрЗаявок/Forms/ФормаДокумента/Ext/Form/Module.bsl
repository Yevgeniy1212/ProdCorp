...
Процедура ЗаполнитьЗаявкиНаСервере()
	...
	Запрос.Текст = 
		...
		|	цс_ЗаявкаНаФинасирование.СтатусЗаявки
		|ИЗ
		|	Документ.цс_ЗаявкаНаФинасирование КАК цс_ЗаявкаНаФинасирование
		|ГДЕ
		|	цс_ЗаявкаНаФинасирование.Дата МЕЖДУ &НачПериода И &КонПериода
		|	И цс_ЗаявкаНаФинасирование.ПометкаУдаления = ЛОЖЬ
		|	И цс_ЗаявкаНаФинасирование.Организация = &Организация";
