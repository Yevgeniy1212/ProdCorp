...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Для каждого СтрокаТЧ ИЗ ВлияющиеПоказатели Цикл
		//Зафиксировать 
		ДвижениеЗависимостей						= Движения.б_ЗависимыеСтатьиДляФакторногоАнализа.Добавить();
		ДвижениеЗависимостей.Бюджет 				= СтруктураШапкиДокумента.ЗависимыйБюджет;
		ДвижениеЗависимостей.ЗависимаяСтатья		= СтруктураШапкиДокумента.ЗависимаяСтатьяБюджета;
		ДвижениеЗависимостей.ВлияющаяСтатья			= СтрокаТЧ.ВлияющаяСтатьяБюджета;
		ДвижениеЗависимостей.ПризнакСуммы		 	= СтрокаТЧ.Коэффициент;
