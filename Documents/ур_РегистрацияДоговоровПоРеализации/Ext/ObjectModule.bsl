...
Функция ПечатьБронирование()
	...
	//|	Организация,
	//|	ВидОперации,
	//|	ИсточникФинансирования КАК источник
	//|ИЗ
	...
	//|ИЗ
	//|	Документ.ур_ЗалоговоеОбеспечениеЗерном.Товары КАК БронированиеЗерна
	//|ГДЕ
	...
	//ОбластьМакета.Параметры.ТекстЗаголовка = РаботаСДиалогами.СформироватьЗаголовокДокумента(ЭтотОбъект, "Залоговое обеспечение ", глСписокПрефиксовУзлов);
...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	Возврат Новый Структура("Наряд","Наряд");
...
Процедура ПроверитьЗаполнениеШапки(СтруктураШапкиДокумента, Отказ, Заголовок)
	...
	СтруктураОбязательныхПолей = Новый Структура("Организация, ИсточникФинансирования");
...
Процедура ДвиженияПоРегистрам(РежимПроведения, СтруктураШапкиДокумента,
		...
		Для Каждого СтрокаРеализации ИЗ ТаблицаПоЗерновымРаспискам Цикл
			ДвижениеРеализации = Движения.ур_ЗерноПоНарядам.Добавить();
			
			ДвижениеРеализации.Период 					= Дата;
			ДвижениеРеализации.Организация 				= СтруктураШапкиДокумента.Организация;
			//ДвижениеРеализации.Склад 	  				= СтрокаРеализации.Склад;
			ДвижениеРеализации.Контрагент		 		= СтруктураШапкиДокумента.Контрагент;
			...
			ДвижениеРеализации.Видресурса				= СтрокаРеализации.ВидРесурса;
			ДвижениеРеализации.Культура 				= СтрокаРеализации.Культура;
			ДвижениеРеализации.Класс					= СтрокаРеализации.Класс;
			ДвижениеРеализации.ГодУрожая				= СтрокаРеализации.ГодУрожая;
			//ДвижениеРеализации.Зерноваярасписка			= СтрокаРеализации.Зерноваярасписка;
			ДвижениеРеализации.Количество 				= СтрокаРеализации.ЗачтенныйВес;
		КонецЦикла;
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ПроверитьЗаполнениеШапки(СтруктураШапкиДокумента, Отказ, Заголовок);
 	...
 	ТаблицаПоЗерновымРаспискам    = УправлениеРесурсами.ПодготовитьТаблицуЗерновыхРасписокПоНарядам(ЭтотОбъект);
