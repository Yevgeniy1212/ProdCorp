...
Процедура ЗаполнитьДокументыНаСервере()
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	ЦС_ДисконтированиеОстатки.Контрагент,
		|	ЦС_ДисконтированиеОстатки.ДоговорКонтрагента,
		|	ЦС_СписокДисконтирования.Регистратор КАК Док,
		|	ЦС_ДисконтированиеОстатки.СуммаОстаток КАК Сумма
		|ИЗ
		|	РегистрНакопления.ЦС_Дисконтирование.Остатки(&КонПериода, Организация = &Организация) КАК ЦС_ДисконтированиеОстатки
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ЦС_СписокДисконтирования КАК ЦС_СписокДисконтирования
		|		ПО ЦС_ДисконтированиеОстатки.Контрагент = ЦС_СписокДисконтирования.Контрагент
		|			И ЦС_ДисконтированиеОстатки.ДоговорКонтрагента = ЦС_СписокДисконтирования.Договор
		|ГДЕ
		|	ЦС_ДисконтированиеОстатки.Организация = &Организация
		|
		|СГРУППИРОВАТЬ ПО
		|	ЦС_ДисконтированиеОстатки.Контрагент,
		|	ЦС_ДисконтированиеОстатки.ДоговорКонтрагента,
		|	ЦС_СписокДисконтирования.Регистратор,
		|	ЦС_ДисконтированиеОстатки.СуммаОстаток";
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		НовСтр.Док = ВыборкаДетальныеЗаписи.Док;
