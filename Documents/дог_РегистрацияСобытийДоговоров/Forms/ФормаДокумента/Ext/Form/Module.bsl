...
Процедура СтруктурноеПодразделениеОрганизацияПриИзменении(Элемент)
	...
	ОрганизацияПриИзмененииНаСервере(Объект.Организация, Объект.ДоговорКонтрагента);
...
Процедура ДоговорКонтрагентаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ДанныеВыбора = ПолучитьСписокДоговоров(Объект.Организация,Объект.СтруктурноеПодразделение,Объект.Контрагент,Объект.Дата);
...
Процедура ОрганизацияПриИзмененииНаСервере(Организация, ДоговорКонтрагента)
...
&НаСервереБезКонтекста
Функция ПолучитьСписокДоговоров(Организация, СтруктурноеПодразделение, Контрагент, Дата)
