...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если Не Отказ Тогда
		фин_УправлениеПроведениемДокументовСервер.СформироватьДвиженияПоРегистрам(ПараметрыПроведения.Реквизиты, ПараметрыПроведения.ТаблицаТовары, Движения, Отказ,"Товары","узп_УправлениеЗакупками","ЗарегистрироватьДвиженияЗаказыПоставщику",,);
		фин_УправлениеПроведениемДокументовСервер.СформироватьДвиженияПоРегистрам(ПараметрыПроведения.Реквизиты, ПараметрыПроведения.ТаблицаУслуги, Движения, Отказ,"Услуги","узп_УправлениеЗакупками","ЗарегистрироватьДвиженияЗаказыПоставщику",,);
	КонецЕсли;
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЕдиныйСрокПоставкиПоЗаказу Тогда
		дог_УправлениеДоговорами.ИсключитьПроверку(ПроверяемыеРеквизиты,"Товары.СрокПоставки");
		дог_УправлениеДоговорами.ИсключитьПроверку(ПроверяемыеРеквизиты,"Услуги.СрокПоставки");
	КонецЕсли;
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	Если ЕдиныйСрокПоставкиПоЗаказу И СрокПоставки<>'00010101' Тогда
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ДанныеЗаполнения <> Неопределено И ТипДанныхЗаполнения <> Тип("Структура") 
		...
		Документы.узп_ЗаказПоставщику.ЗаполнитьПоДокументуОснованию(ЭтотОбъект, ДанныеЗаполнения);
		Возврат;
	КонецЕсли;
