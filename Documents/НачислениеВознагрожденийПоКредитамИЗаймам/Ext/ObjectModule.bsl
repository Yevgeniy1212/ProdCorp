...
Функция ПечатьГрафика()
	...
	|ИЗ
	|	Документ.НачислениеВознагрожденийПоКредитамИЗаймам КАК ГрафикВознагрождений
	|ГДЕ
	...
	|ИЗ
	|	Документ.НачислениеВознагрожденийПоКредитамИЗаймам.График КАК ГрафикВознагрождений
	|ГДЕ
	|	 ГрафикВознагрождений.ссылка = &ТекДокумент
	|Итоги 
