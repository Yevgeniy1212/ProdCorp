...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Для каждого СтрокаТЧ ИЗ СписокТарифов Цикл
		//Зафиксировать 
		ДвижениеЗависимостей						= Движения.б_ТарифыНаХранение.Добавить();
		ДвижениеЗависимостей.Период	 				= СтруктураШапкиДокумента.Дата;
		ДвижениеЗависимостей.Организация			= СтруктураШапкиДокумента.Организация;
		ДвижениеЗависимостей.Склад 					= СтрокаТЧ.Склад;
		ДвижениеЗависимостей.ВидРесурса 			= СтрокаТЧ.ВидРесурса;
		ДвижениеЗависимостей.цена 					= СтрокаТЧ.цена;
