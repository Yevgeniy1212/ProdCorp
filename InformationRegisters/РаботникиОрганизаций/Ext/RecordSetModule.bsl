...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	ПолныеПрава.ЗаписатьТекущиеКадровыеДанныеСотрудникаОрганизации(Отказ, Замещение, Истина, Отбор.Регистратор.Значение);
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ПолныеПрава.ЗаписатьТекущиеКадровыеДанныеСотрудникаОрганизации(Отказ, Замещение, Ложь, Отбор.Регистратор.Значение);
