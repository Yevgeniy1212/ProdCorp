...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	ПолныеПрава.ЗаписатьТекущиеКадровыеДанныеСотрудника(Отказ, Замещение, Истина, Отбор.Регистратор.Значение);
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ПолныеПрава.ЗаписатьТекущиеКадровыеДанныеСотрудника(Отказ, Замещение, Ложь, Отбор.Регистратор.Значение);
